...
> **ESTADO ACTUAL:** Este repositorio es un **prototipo funcional** inicial. Sirve como prueba de concepto (PoC) y base arquitectónica. Está en espera para una evolución y desarrollo de características futuras.
